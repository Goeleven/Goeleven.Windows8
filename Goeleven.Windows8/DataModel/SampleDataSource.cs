...
namespace Goeleven.Windows8.Data
{
    /// <summary>
    ...
    public abstract class SampleDataCommon : Goeleven.Windows8.Common.BindableBase
    {
    ...
    public sealed class SampleDataSource
    {
        ...
        private ObservableCollection<WallMessage> wallMessage = new ObservableCollection<WallMessage>();
        public ObservableCollection<WallMessage> WallMessages
        {
            get { return this.wallMessage; }
        }
        ...
        public SampleDataSource()
        {
            ...
            this.WallMessages.Add(new WallMessage(
                "/Images/f62ebe822f6b351538e68cb2bbadefe9.jpeg",
                "Maarten Balliauw",
                "Hoe plaats je best een glazen deur zonder brokken te maken?",
                "7 Comments"
            ));
            this.WallMessages.Add(new WallMessage(
                "/Images/9925a436e7c82740344087c39ed1a078.jpeg",
                "Yves Goeleven",
            ...
            this.WallMessages.Add(new WallMessage(
                "/Images/8909a2d7205fecc4481ddbbe30abfd2e.jpeg",
                "Kristof Rennen",
    ...
    [Windows.Foundation.Metadata.WebHostHidden]
    public class WallMessage : Goeleven.Windows8.Common.BindableBase
    {
        private static Uri _baseUri = new Uri("ms-appx:///");

        public WallMessage(String image, String title, String question, String numberOfComments)
        {
            this.title = title;
        ...
        private string numberOfComments = string.Empty;
        public string NumberOfComments
        {
            get { return this.numberOfComments; }
            set { this.SetProperty(ref this.numberOfComments, value); }
        }
